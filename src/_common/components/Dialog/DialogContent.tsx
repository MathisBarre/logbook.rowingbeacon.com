...
>(({ className, children, title = "Title", subtitle, ...props }, ref) => (
  <DialogPortal container={document.getElementById("dialog-portal-root")}>
    ...
    <DialogPrimitive.Content
      ...
      ref={ref}
      className={cn(
        "w-[48rem] max-h-[calc(100vh-4rem)] max-w-[calc(100vw-4rem)] overflow-y-auto bg-white bg-opacity-100 fixed left-[50%] top-[50%] z-50 grid translate-x-[-50%] translate-y-[-50%] border overflow-hidden shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg",
        className
      )}
      {...props}
    >
