...
>(({ className, children, title = "Title", subtitle, ...props }, ref) => (
  <DialogPortal container={document.getElementById("dialog-portal-root")}>
    ...
    <DialogPrimitive.Content
      ...
      ref={ref}
      className={cn(
        "w-[48rem] max-h-[calc(100vh-4rem)] max-w-[calc(100vw-4rem)]  bg-white bg-opacity-100 fixed z-50 grid border overflow-hidden shadow-lg sm:rounded-lg dialog-animation position-centered",
